 ...
 * @author Usuario
 */
public class Ej_6_extra_prueba {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            do {
                fila = (int) ((Math.random() * 10)/2);  //Da numero del 0 al 4
                //fila = (int) (Math.random() * 20 + 1);  //Da numero del 1 al 20
                //System.out.println(fila);
